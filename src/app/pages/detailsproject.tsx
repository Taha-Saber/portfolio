...
const Details = () => {
  ...
  if (!project)
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#080d0d]">
        <p className="text-gray-600 font-mono text-sm">Project not found</p>
      </div>
    );

  return (
    <div className="min-h-screen bg-[#080d0d] flex items-center justify-center px-6 py-12">
       ...
       <div className="flex flex-col lg:flex-row-reverse items-stretch gap-10 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 object-cover">
            <div className="relative rounded-2xl overflow-hidden group h-full min-h-[300px] lg:min-h-[420px] border border-white/5 shadow-[0_0_80px_rgba(37,193,221,0.06)]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#080d0d]/40 via-transparent to-transparent pointer-events-none" />
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between gap-7 py-2">
            ...
            <p className="text-sm md:text-[15px] text-gray-400 leading-relaxed whitespace-pre-wrap flex-1">
              {project.description}
            </p>
